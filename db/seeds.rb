...
card4 = Card.create(title: 'This is the fourth card', list: list3)

Comment.create(user: 'Jane Doe', text: 'First comment here.', card: card4)
Comment.create(user: 'Billy Bob', text: 'Second comment here.', card: card4)
Comment.create(user: 'Unicorn', text: 'Third comment here.', card: card4)
